        ...
        <nav class="navbar" data-navbar>
          ...
          <div class="navbar-bottom">
            <ul class="navbar-list">
              ...
              <li>
                <a href="../afterUsersLogin/about.php" class="navbar-link active" data-nav-link >About</a>
              </li>
              ...
              <li>
                <a href="../afterUsersLogin/properties.php" class="navbar-link" data-nav-link style="color: var(--orange-soda);">Property</a>
              </li>
    ...
    <article>
        <section class="property" id="property">
            <div class="container">
              ...
              <p class="section-subtitle" style="margin-top:0px">Residential</p> <br>
