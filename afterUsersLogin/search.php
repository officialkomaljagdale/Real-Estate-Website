...
<body>
  ...
  -->
                ...
                <nav class="navbar" data-navbar>
                    ...
                    <div class="navbar-bottom">
                        <ul class="navbar-list">
                            ...
                            <li>
                                <a href="../afterUsersLogin/indexLoginUser.php" class="navbar-link" data-nav-link>Home</a>
                            </li>
    ...
    <div class="cards" style="background-color: rgb(241,245,247);">
        ...
        ?>
        <h2 class="h2 section-title">Search Your Property In<em>"
        ...
        <div class="container">
            ...
            <ul class="property-list has-scrollbar">
                ...
                <?php
                $sqlForProperties = "SELECT* from property where match (city, ptype, plocation) against ('$searchQuery');";
                $querySqlForProperties = mysqli_query($conn, $sqlForProperties);
                $numRows = mysqli_num_rows($querySqlForProperties);
                if ($numRows == 0) {
                    echo '
                    <div class="searchResult">
                        <div class="resultNotFound">
                            <div class="message">
                                <h4>Your search - ' . $searchQuery . ' ... - did not match any property. </h4>
                                <br>
                                <p><b>Suggestions:</b></p>
                            ...
                            <div class="image">
                                <img src="../assets/images/download.svg" alt="Image description">
                            </div>
                        </div>
                    </div>
                ';
